...
def load_available_models_from_env() -> List[ModelConfig]:
    """从环境变量加载可用模型列表"""
    default_models = [
        ModelConfig(model_id=MODEL_ID_FLASH, display_name="Qwen-Flash", icon="Zap", icon_color="yellow-400"),
        ModelConfig(model_id=MODEL_ID_PLUS, display_name="Qwen-Plus", icon="Zap", icon_color="orange-400"),
        ModelConfig(model_id=MODEL_ID_MAX, display_name="Qwen-Max", icon="Cpu", icon_color="purple-400"),
    ]
